...
exports.prep_data = function(data) {
    let keys = ["vendor", "date", "site", "code", "status", "notes", "product", "quantity",
                "price", "createdAt",  "vendor_name", "unit", "product_name", "expiry"]
    var returner = {};
...
exports.search = function (param, limit, offset) {
    let final_query= []
    let fields = ["code", "site", "notes", "product_name", "vendor_name"];
